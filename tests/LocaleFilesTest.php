...
/**
 * @file plugins/generic/requiredMultilingualMetadata/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public const PLACEHOLDERS = [
        'plugins.generic.requiredMultilingualMetadata.error.required' => ['{$language}'],
        'plugins.generic.requiredMultilingualMetadata.field.notice' => ['{$languages}'],
    ];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.requiredMultilingualMetadata\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
