...
/**
 * @file plugins/generic/requiredMultilingualMetadata/tests/PluginTest.php
 *
...
class PluginTest extends PKPTestCase
{
    ...
    {
        return [
            \APP\plugins\generic\requiredMultilingualMetadata\RequiredMultilingualMetadataPlugin::class,
            \APP\plugins\generic\requiredMultilingualMetadata\RequiredMultilingualMetadataSettingsForm::class,
        ];
    }
